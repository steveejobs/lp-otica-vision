...
import styles from "./focused-product-details.module.css";

/**
 * Progressive details shown when a product is focused.
 * This is an ADDITIONAL child inside the article, NOT a replacement.
 * The article's button + flip-frame + media remain mounted above.
 */
export function FocusedProductDetails({ product }: { product: CatalogProduct }) {
