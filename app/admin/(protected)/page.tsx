...
export default async function AdminDashboardPage({ searchParams }: DashboardPageProps) {
  ...
  return (
    <>
      <AdminPageHeader
        description="Uma leitura objetiva do conteúdo publicado. A base começa vazia para evitar qualquer produto, oferta ou marca fictícia."
      ...
      <div className={styles.sectionBar}>
        ...
        <span className={styles.phaseBadge}>Fase 1 · sem dados fictícios</span>
      </div>
