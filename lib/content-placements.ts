...
export const PUBLIC_PLACEMENTS = [
  ...
  },
  {
    ...
    description: "Vídeos editoriais fixos da página Bio. Esta posição ainda não possui um editor de vídeo no ADM.",
    device: "both",
    galleryMedia: false,
    href: "/bio#hero-bio",
    key: "instagram.hero",
    label: "Bio › Hero em movimento",
    maxItems: 0,
    minItems: 0,
    placementKey: "hero",
  ...
  },
  {
    ...
    description: "Seleção editorial de imagens da rota Bio, depois do vídeo completo e antes das marcas.",
    device: "both",
    galleryMedia: true,
    href: "/bio#selecao-editorial",
    key: "instagram.editorial_selection",
    label: "Bio › Seleção editorial",
    maxItems: 6,
    minItems: 1,
